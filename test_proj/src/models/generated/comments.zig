...
pub const rel_replies = includeQuery.RelationMeta{
    .name = "replies",
    .table = "comments",
...
pub const rel_parent = includeQuery.RelationMeta{
    .name = "parent",
    .table = "comments",
    .foreign_key = "parent_id",
    .local_key = "id",
...
/// Query Comments with Replies included (eager loading)
pub fn includeReplies(db: Executor, allocator: std.mem.Allocator, where_clause: ?[]const u8, args: anytype) ![]includeQuery.WithRelation(Comments, Comments, "replies") {
